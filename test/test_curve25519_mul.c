...
char fa[] = {
    ...
    "mov r13, r11; x136, copying x133 here, cause x133 is needed in a reg for "
    ...
    "mov rbp, r11; x141, copying x138 here, cause x138 is needed in a reg for "
    ...
    "mov rax, r10; x147, copying x143 here, cause x143 is needed in a reg for "
    ...
    "mov r10, [ rsp + 0x40 ]; x142, copying x138 here, cause x138 is needed in "
...
char fb[] = {
    ...
    "adox r8, rbp\n"
    "mov r15, r11; x136, copying x133 here, cause x133 is needed in a reg for "
    "other than x136, namely all: , x136, x137, size: 2\n"
    ...
    "adc r9, 0x0\n"
    "mov r12, rax; x141, copying x138 here, cause x138 is needed in a reg for "
    "other than x141, namely all: , x141, x142, size: 2\n"
    ...
    "adox r12, r15\n"
    "adc r12, 0x0\n"
    "mov r10, rdi; x151, copying x148 here, cause x148 is needed in a reg for "
    "other than x151, namely all: , x151, x152, size: 2\n"
    "shrd r10, r12, 51; x151 <- x150||x148 >> 51\n"
    "imul r10, r10, 0x13; x153 <- x151 * 0x13\n"
    "add r10, [ rsp + 0x40 ]\n"
    "mov rbp, r10; x155, copying x154 here, cause x154 is needed in a reg for "
    "other than x155, namely all: , x155, x156, size: 2\n"
