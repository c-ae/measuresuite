...
char fa[] = {
    ...
    "mov rbx, r15;x10004_1, copying x3_1 here, cause x3_1 is needed in a reg. "
    "It has those deps: \"\", current hard deps: \"x3_0, x3_1\"\n"
    "adcx rcx, r9\n"
    "adcx rbx, r8\n"
    "mov r15, r14;x10_1, copying x9_1 here, cause x9_1 is needed in a reg. It "
    ...
    "mov rdx, r12;x13_1, copying x7_1 here, cause x7_1 is needed in a reg. It "
...
char fb[] = {
    ...
    "mov r12, rbp;x10005_1, copying x5_1 here, cause x5_1 is needed in a reg. "
    ...
    "adcx r11, [ rsp + 0x38 ]\n"
    "adcx r12, [ rsp + 0x30 ]\n"
    "mov rdx, r15;x10006_1, copying x6_1 here, cause x6_1 is needed in a reg. "
    "It has those deps: \"\", current hard deps: \"x6_0, x6_1\"\n"
    "test al, al\n"
    "adox rcx, r9\n"
    "adox rdx, rbx\n"
    ...
    "mov rbx, r14;x10004_1, copying x3_1 here, cause x3_1 is needed in a reg. "
    "It has those deps: \"\", current hard deps: \"x3_0, x3_1\"\n"
    "xor rdx, rdx\n"
    "adox r15, rax\n"
    "adox rbx, rbp\n"
    ...
    "mov r14, r15;x12, copying x10_0 here, cause x10_0 is needed in a reg. It "
    ...
    "mov rbp, r14;x27, copying x25 here, cause x25 is needed in a reg. It has "
    "those deps: \"x26, x27, size: 2\", current hard deps: \"\"\n"
