...
int main() {
  ...
  if (ms_measure_init(&ms, arg_width, arg_num_in, arg_num_out, chunksize, bounds,
                   "./libcheckfunctions-clang-AMD.so", symbol)) {
...
char fa[] = {
    ...
    "mov rdx, r12;x15_1, copying x9_1 here, cause x9_1 is needed in a reg. It "
    "has those deps: "
    ", current hard deps: "
    "\n"
    "adcx r15, r13\n"
    ...
    "mov rdx, r9;x11_1, copying x10_1 here, cause x10_1 is needed in a reg. It "
    "has those deps: "
    ...
    "adc r14, 0x0\n"
    "mov r10, r15;x17, copying x16_0 here, cause x16_0 is needed in a reg. It "
    ...
    "adox rcx, r10\n"
    "adox r8, r12\n"
    "mov rdx, rcx;x21, copying x19_0 here, cause x19_0 is needed in a reg. It "
...
char fb[] = {
    ...
    "mov rdx, r14;x14_1, copying x8_1 here, cause x8_1 is needed in a reg. It "
    "has those deps: "
    ...
    "mov rdx, r13;x15_1, copying x9_1 here, cause x9_1 is needed in a reg. It "
    "has those deps: "
    ...
    "mov r13, r9;x11_1, copying x10_1 here, cause x10_1 is needed in a reg. It "
    "has those deps: "
    ...
    "adc r10, 0x0\n"
    "mov r14, rax;x20, copying x19_0 here, cause x19_0 is needed in a reg. It "
    "has those deps: \"x20, x21, size: 2\", current hard deps: "
    "\n"
