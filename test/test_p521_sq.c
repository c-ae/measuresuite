...
char fa[] = {
    ...
    "mov rax, rdi; x125, copying x119 here, cause x119 is needed in a reg for "
    ...
    "mov rdx, [ rsp + 0x38 ]; x124, copying x121 here, cause x121 is needed in "
    ...
    "adox rbp, [ rsp + 0x70 ]\n"
    "adcx rcx, rbp\n"
    "mov rdx, rbx; x265, copying x261 here, cause x261 is needed in a reg for "
    ...
    "mov rbx, r15; x272, copying x268 here, cause x268 is needed in a reg for "
    ...
    "mov rbp, rbx; x279, copying x275 here, cause x275 is needed in a reg for "
    ...
    "adox r9, r15\n"
    "adcx rcx, r9\n"
    "mov r10, r12; x293, copying x289 here, cause x289 is needed in a reg for "
    ...
    "mov rdx, r14; x300, copying x296 here, cause x296 is needed in a reg for "
    ...
    "mov r11, [ rsp + 0x60 ]; x260, copying x254 here, cause x254 is needed in "
    ...
    "mov rax, rdx; x317, copying x315 here, cause x315 is needed in a reg for "
    ...
    "mov r10, [ rsp + 0xd0 ]; x288, copying x282 here, cause x282 is needed in "
    ...
    "=0.996519180392579\n"
    "; number reverted spill/ tried spill: 27437 / 27546 =0.9960429826472083\n"
...
char fb[] = {
    ...
    "mov rdx, rbx; x258, copying x254 here, cause x254 is needed in a reg for "
    "other than x258, namely all: , x260, x258, size: 2\n"
    ...
    "mov rdx, rbx; x272, copying x268 here, cause x268 is needed in a reg for "
    "other than x272, namely all: , x274, x272, size: 2\n"
    ...
    "mov rdx, r13; x279, copying x275 here, cause x275 is needed in a reg for "
    "other than x279, namely all: , x279, x281, size: 2\n"
    ...
    "sar  r8b, 1\n"
    "adcx r14, r12\n"
    "mov rcx, r10; x286, copying x282 here, cause x282 is needed in a reg for "
    "other than x286, namely all: , x286, x288, size: 2\n"
    ...
    "adox r13, r9\n"
    "adcx r14, r13\n"
    "mov rcx, rbp; x293, copying x289 here, cause x289 is needed in a reg for "
    "other than x293, namely all: , x293, x295, size: 2\n"
    ...
    "mov r10, rax; x300, copying x296 here, cause x296 is needed in a reg for "
    "other than x300, namely all: , x302, x300, size: 2\n"
    ...
    "add r8, [ rsp + 0x40 ]; could be done better, if r0 has been u8 as well\n"
    "adc r14, 0x0\n"
    ...
    "mov r15, [ rsp + 0x58 ]; x260, copying x254 here, cause x254 is needed in "
    "a reg for other than x260, namely all: , x260, size: 1\n"
    "and r15, r13; x260 <- x254& 0x3ffffffffffffff\n"
    "lea r11, [ r11 + r15 ]\n"
    "mov rcx, 0x1ffffffffffffff ; moving imm to reg\n"
    "and r9, rcx; x309 <- x303& 0x1ffffffffffffff\n"
    "mov r10, r11; x317, copying x315 here, cause x315 is needed in a reg for "
    "other than x317, namely all: , x317, x316, size: 2\n"
    ...
    "mov r12, [ rsp + 0x60 ]; x267, copying x261 here, cause x261 is needed in "
    "a reg for other than x267, namely all: , x267, size: 1\n"
    "and r12, r13; x267 <- x261& 0x3ffffffffffffff\n"
    "mov rbx, [ rsp + 0x78 ]; x274, copying x268 here, cause x268 is needed in "
    "a reg for other than x274, namely all: , x274, size: 1\n"
    "and rbx, r13; x274 <- x268& 0x3ffffffffffffff\n"
    "mov [ rdx + 0x18 ], rbx; out1[3] = x274\n"
    "lea r11, [ r11 + r12 ]\n"
    "mov r14, [ rsp + 0x88 ]; x281, copying x275 here, cause x275 is needed in "
    "a reg for other than x281, namely all: , x281, size: 1\n"
    ...
    "mov r15, [ rsp + 0xa8 ]; x288, copying x282 here, cause x282 is needed in "
    "a reg for other than x288, namely all: , x288, size: 1\n"
    ...
    "=0.9971074996272551\n"
    "; number reverted spill/ tried spill: 33108 / 33218 =0.9966885423565537\n"
