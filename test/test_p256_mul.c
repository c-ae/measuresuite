...
char fa[] = {
    ...
    "adox rcx, [ rsp + 0x0 ]\n"
    "movzx r13, r10b; x72, copying x71 here, cause x71 is needed in a reg for "
    ...
    "mov rax, r14; x174, copying x165 here, cause x165 is needed in a reg for "
    ...
    "movzx rdx, cl; x175, copying x175 here, cause x175 is needed in a reg for "
    "other than x175, namely all: , x176--x177, size: 1\n"
    "add rdx, -0x1\n"
    "mov rcx, rbp; x176, copying x167 here, cause x167 is needed in a reg for "
    "other than x176, namely all: , x176--x177, x185, size: 2\n"
    "mov [ rsp + 0x110 ], rax; spilling x174 to mem\n"
    "mov rax, 0xffffffff ; moving imm to reg\n"
    "sbb rcx, rax\n"
    "movzx rax, r15b; x83, copying x63 here, cause x63 is needed in a reg for "
    ...
    "movzx r15, r11b; x98, copying x97 here, cause x97 is needed in a reg for "
    ...
    "xchg rdx, r9; 0xffffffff00000001, swapping with x130, which is currently "
    "in rdx\n"
    ...
    "movzx r10, cl; x177, copying x177 here, cause x177 is needed in a reg for "
    "other than x177, namely all: , x178--x179, size: 1\n"
    "add r10, -0x1\n"
    "mov r10, rax; x178, copying x169 here, cause x169 is needed in a reg for "
    ...
    "adox r14, rdx\n"
    "mov r12, rcx; x180, copying x171 here, cause x171 is needed in a reg for "
...
char fb[] = {
    ...
    "mov [ rsp + 0x20 ], rdx; spilling x1 to mem\n"
    "mov rdx, [ rsp + 0x88 ]; x37, copying x21 here, cause x21 is needed in a "
    ...
    "mov rdx, rcx; _, copying x99 here, cause x99 is needed in a reg for other "
    ...
    "adcx rbp, [ rsp + 0xe0 ]\n"
    "mov rdx, [ rsp + 0xd0 ]; x81, copying x65 here, cause x65 is needed in a "
    ...
    "movzx rdx, r10b; x83, copying x82 here, cause x82 is needed in a reg for "
    "other than x83, namely all: , x83, size: 1\n"
    "movzx rbx, bl\n"
    "lea rdx, [ rdx + rbx ]\n"
    "clc;\n"
    ...
    "xchg rdx, r11; 0xffffffff00000001, swapping with x83, which is currently "
    "in rdx\n"
    ...
    "mov r11, rbp; x174, copying x165 here, cause x165 is needed in a reg for "
    ...
    "adcx r8, rbx\n"
    "mov r9, [ rsp + 0x38 ]; x150, copying x141 here, cause x141 is needed in "
    "a reg for other than x150, namely all: , x150--x151, size: 1\n"
    "adox r9, rcx\n"
    "movzx rcx, dl; x128, copying x127 here, cause x127 is needed in a reg for "
    "other than x128, namely all: , x128, size: 1\n"
    "movzx r12, r12b\n"
    "lea rcx, [ rcx + r12 ]\n"
    "mov r12, [ rsp + 0x58 ]; x152, copying x143 here, cause x143 is needed in "
    ...
    "mov r9, 0xffffffff ; moving imm to reg\n"
    "sbb r10, r9\n"
    "mov rcx, r13; x178, copying x169 here, cause x169 is needed in a reg for "
    "other than x178, namely all: , x186, x178--x179, size: 2\n"
    "sbb rcx, 0x00000000\n"
    "inc r15; OF<-0x0, preserve CF (debug: state 2)\n"
    "mov r15, -0x1 ; moving imm to reg\n"
    ...
    "adox r12, rax\n"
    "movzx rax, bl; x173, copying x153 here, cause x153 is needed in a reg for "
    "other than x173, namely all: , x173, size: 1\n"
    "mov rdx, 0x0 ; moving imm to reg\n"
    "adox rax, rdx\n"
    "mov rbx, r12; x180, copying x171 here, cause x171 is needed in a reg for "
    ...
    "=0.701006229036895\n"
    "; number reverted spill/ tried spill: 23108 / 33078 =0.6985912086583228\n"
