...
char fa[] = {
    ...
    "movzx rdx, r10b; x72, copying x71 here, cause x71 is needed in a reg for "
    ...
    "xchg rdx, rbx; 0xffffffffffffffff, swapping with x65, which is currently "
    "in rdx\n"
    ...
    "save it. I this a hack?)\n"
    "adox rbx, rbp\n"
    "movzx rbx, cl; x117, copying x116 here, cause x116 is needed in a reg for "
    ...
    "xchg rdx, r12; 0xffffffff00000001, swapping with x38, which is currently "
    "in rdx\n"
    ...
    "mov rax, r15; x174, copying x165 here, cause x165 is needed in a reg for "
    ...
    "movzx rdx, r12b; x83, copying x63 here, cause x63 is needed in a reg for "
    ...
    "adox rcx, [ rsp + 0x138 ]\n"
    "mov r14, [ rsp + 0x140 ]; x98, copying x85 here, cause x85 is needed in a "
    ...
    "xchg rdx, r13; 0xffffffff00000001, swapping with x107, which is currently "
    "in rdx\n"
    ...
    "add r12, -0x1\n"
    "mov r12, rcx; x176, copying x167 here, cause x167 is needed in a reg for "
    ...
    "adox r13, [ rsp + 0x30 ]\n"
    "mov r11, [ rsp + 0x8 ]; x152, copying x143 here, cause x143 is needed in "
    ...
    "adox r8, rdx\n"
    "mov rbx, r13; x178, copying x169 here, cause x169 is needed in a reg for "
    ...
    "=0.9656833232992174\n"
    "; number reverted spill/ tried spill: 28863 / 29938 =0.9640924577460084\n"
...
char fb[] = {
    ...
    "mov r13, rdx; _, copying x54 here, cause x54 is needed in a reg for other "
    ...
    "mov rdx, [ rsp + 0x30 ]; x72, copying x67 here, cause x67 is needed in a "
    ...
    "lea r9, [ r9 + r13 ]\n"
    "mov r13, 0xffffffff ; moving imm to reg\n"
    "xchg rdx, r13; 0xffffffff, swapping with x80, which is currently in rdx\n"
    ...
    "mov r12, r10; x174, copying x165 here, cause x165 is needed in a reg for "
    "other than x174, namely all: , x174--x175, x184, size: 2\n"
    ...
    "adox r9, rbx\n"
    "mov r15, [ rsp + 0x140 ]; x98, copying x85 here, cause x85 is needed in a "
    "reg for other than x98, namely all: , x98, size: 1\n"
    "mov rax, 0x0 ; moving imm to reg\n"
    "adcx r15, rax\n"
    "clc;\n"
    ...
    "add rcx, -0x1\n"
    "mov rcx, r15; x178, copying x169 here, cause x169 is needed in a reg for "
    "other than x178, namely all: , x186, x178--x179, size: 2\n"
    "sbb rcx, 0x00000000\n"
    "mov rbp, r8; x180, copying x171 here, cause x171 is needed in a reg for "
    "other than x180, namely all: , x187, x180--x181, size: 2\n"
    "sbb rbp, rdx\n"
    "movzx rbx, r13b; _, copying x173 here, cause x173 is needed in a reg for "
    ...
    "=0.9659610295886456\n"
    "; number reverted spill/ tried spill: 32031 / 33217 =0.9642953909142908\n"
