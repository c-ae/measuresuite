...
char fa[] = {
    ...
    "xchg rdx, rcx; 0xffffffff, swapping with x92, which is currently in rdx\n"
    ...
    "xchg rdx, r11; 0x100000001, swapping with x2, which is currently in rdx\n"
    "mulx rbx, r9, r12; _, x183<- x169 * 0x100000001\n"
    "mov rbx, 0xffffffff ; moving imm to reg\n"
    "xchg rdx, r9; x183, swapping with 0x100000001, which is currently in rdx\n"
    ...
    "xchg rdx, r15; 0xffffffff, swapping with 0x100000001, which is currently "
    "in rdx\n"
    ...
    "xchg rdx, r11; 0xffffffff00000000, swapping with x213, which is currently "
    "in rdx\n"
    ...
    "xchg rdx, r9; 0x100000001, swapping with x288, which is currently in rdx\n"
    ...
    "xchg rdx, r14; 0xffffffff00000000, swapping with x313, which is currently "
    "in rdx\n"
    ...
    "xchg rdx, rax; 0xffffffff, swapping with x400, which is currently in rdx\n"
    ...
    "xchg rdx, r11; 0xffffffffffffffff, swapping with x365, which is currently "
    "in rdx\n"
    ...
    "adox r9, r11\n"
    "mov r14, 0xffffffffffffffff ; moving imm to reg\n"
    "xchg rdx, r14; 0xffffffffffffffff, swapping with x217, which is currently "
    "in rdx\n"
    ...
    "xchg rdx, r15; 0xfffffffffffffffe, swapping with x279, which is currently "
    "in rdx\n"
    ...
    "xchg rdx, rbp; 0xffffffffffffffff, swapping with x455, which is currently "
    "in rdx\n"
    ...
    "xchg rdx, r13; 0xfffffffffffffffe, swapping with x317, which is currently "
    "in rdx\n"
    ...
    "add rdx, -0x1\n"
    "mov rdx, rcx; x456, copying x443 here, cause x443 is needed in a reg for "
    ...
    "sbb rdx, r10\n"
    "movzx r10, al; x168, copying x167 here, cause x167 is needed in a reg for "
    ...
    "add r10, -0x1\n"
    "mov r10, r13; x458, copying x445 here, cause x445 is needed in a reg for "
    ...
    "adox rax, [ rsp + 0x4a0 ]\n"
    "mov r13, 0xffffffffffffffff ; moving imm to reg\n"
    "xchg rdx, r13; 0xffffffffffffffff, swapping with x301, which is currently "
    "in rdx\n"
    ...
    "adcx rax, rbx\n"
    "mov r14, 0xffffffffffffffff ; moving imm to reg\n"
    "xchg rdx, r14; 0xffffffffffffffff, swapping with x360, which is currently "
    "in rdx\n"
    ...
    "add rcx, -0x1\n"
    "mov rcx, rax; x460, copying x447 here, cause x447 is needed in a reg for "
    ...
    "adox r9, r13\n"
    "mov r11, 0xffffffffffffffff ; moving imm to reg\n"
    "xchg rdx, r11; 0xffffffffffffffff, swapping with x409, which is currently "
    "in rdx\n"
    ...
    "adox rbx, r14\n"
    "movzx rdx, al; x376, copying x375 here, cause x375 is needed in a reg for "
    ...
    "mov r10, rdx; x464, copying x451 here, cause x451 is needed in a reg for "
...
char fb[] = {
    ...
    "mov r12, 0xffffffff00000000 ; moving imm to reg\n"
    "xchg rdx, r13; x30, swapping with 0xffffffff, which is currently in rdx\n"
    ...
    "xchg rdx, r14; 0x100000001, swapping with x58, which is currently in rdx\n"
    "mov [ rsp + 0x40 ], rbx; spilling x168 to mem\n"
    "mulx rcx, rbx, r8; _, x106<- x92 * 0x100000001\n"
    "mov rcx, 0xffffffff ; moving imm to reg\n"
    "xchg rdx, rcx; 0xffffffff, swapping with 0x100000001, which is currently "
    "in rdx\n"
    ...
    "xchg rdx, r10; 0xffffffff, swapping with 0x100000001, which is currently "
    "in rdx\n"
    ...
    "adcx r12, [ rsp + 0x8 ]\n"
    "mov r13, 0xffffffffffffffff ; moving imm to reg\n"
    "xchg rdx, r13; 0xffffffffffffffff, swapping with x172, which is currently "
    "in rdx\n"
    ...
    "adox r9, [ rsp + 0x48 ]\n"
    "mov rbx, 0xffffffffffffffff ; moving imm to reg\n"
    "xchg rdx, rbx; 0xffffffffffffffff, swapping with x106, which is currently "
    "in rdx\n"
    ...
    "xchg rdx, r13; 0x100000001, swapping with x5, which is currently in rdx\n"
    ...
    "adox r11, rcx\n"
    "mov r13, 0xffffffff00000000 ; moving imm to reg\n"
    "xchg rdx, r13; 0xffffffff00000000, swapping with x390, which is currently "
    "in rdx\n"
    ...
    "mov rcx, r11; x454, copying x441 here, cause x441 is needed in a reg for "
    "other than x454, namely all: , x468, x454--x455, size: 2\n"
    ...
    "xchg rdx, r15; 0xffffffffffffffff, swapping with x179, which is currently "
    "in rdx\n"
    ...
    "xchg rdx, r8; 0xffffffffffffffff, swapping with x219, which is currently "
    "in rdx\n"
    ...
    "movzx r13, al; x145, copying x105 here, cause x105 is needed in a reg for "
    ...
    "needed in a reg for other than x455, namely all: , x456--x457, size: 1\n"
    "add r10, -0x1\n"
    "mov r10, r15; x456, copying x443 here, cause x443 is needed in a reg for "
    ...
    "adcx r13, rax\n"
    "mov rcx, 0xffffffffffffffff ; moving imm to reg\n"
    "xchg rdx, rcx; 0xffffffffffffffff, swapping with x224, which is currently "
    "in rdx\n"
    ...
    "needed in a reg for other than x457, namely all: , x458--x459, size: 1\n"
    "add rdx, -0x1\n"
    "mov rdx, r13; x458, copying x445 here, cause x445 is needed in a reg for "
    "other than x458, namely all: , x470, x458--x459, size: 2\n"
    ...
    "adcx r9, r8\n"
    "movzx r14, al; x299, copying x259 here, cause x259 is needed in a reg for "
    ...
    "add r12, -0x1\n"
    "mov r10, r14; x462, copying x449 here, cause x449 is needed in a reg for "
    ...
    "adox rbp, r11; loading flag\n"
    "adox r12, rbx\n"
    "movzx r8, cl; x438, copying x437 here, cause x437 is needed in a reg for "
    ...
    "add rax, -0x1\n"
    "mov rbp, r12; x464, copying x451 here, cause x451 is needed in a reg for "
    "other than x464, namely all: , x464--x465, x473, size: 2\n"
    "mov rax, 0xffffffffffffffff ; moving imm to reg\n"
    "sbb rbp, rax\n"
    ...
    "mov r8, [ rsp + 0x350 ]; x468, copying x454 here, cause x454 is needed in "
    ...
    "mov r9, [ rsp + 0x428 ]; x469, copying x456 here, cause x456 is needed in "
    ...
    "=0.9975192779006515\n"
    "; number reverted spill/ tried spill: 33204 / 33273 =0.9979262465061762\n"
